...
{
    public class ClientesController_Becape : ApiController
    {
        // DataContext sendo instanciado
        private EcommerceDataContext db = new EcommerceDataContext();

        // GET: api/Clientes
        public IQueryable<Cliente> GetClientes()
        {
            return db.Clientes.Include("Telefones");
        }
        ...
        public IHttpActionResult PostCliente(Cliente cliente)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = cliente.Cpf }, cliente);
        }
        ...
        {
            return db.Clientes.Count(e => e.Cpf == id) > 0;
        }
    }
}